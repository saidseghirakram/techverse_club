...
const BentoCard = ({
  ...
  >
    ...
    {isActive && (<div className="pointer-events-none absolute inset-0 transform-gpu transition-all duration-300 group-focus:bg-black/[.1] lg:group-hover:bg-black/[.1]" />)}
  </div>
);
